 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://bl.model.ehealth/", wsdlLocation = "http://quiet-eyrie-9945.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://bl.model.ehealth/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://quiet-eyrie-9945.herokuapp.com/ws/people?wsdl");
    ...
    public PeopleBL getPeopleImplPort() {
        return super.getPort(new QName("http://bl.model.ehealth/", "PeopleImplPort"), PeopleBL.class);
    }
     ...
     */
    @WebEndpoint(name = "PeopleImplPort")
    public PeopleBL getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bl.model.ehealth/", "PeopleImplPort"), PeopleBL.class, features);
    }
